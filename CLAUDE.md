...
- `STAAN_API_TOKEN` — API token; if unset, web search is silently disabled
- `STAAN_TOP_K` — number of web results (default: 5)
- `STAAN_MARKET` — search market locale (default: `fr-FR`)
